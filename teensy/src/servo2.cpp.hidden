/*
 Servo2.cpp - Interrupt driven Servo2 library for Arduino using 16 bit timers- Version 2
...
/* 
 ...
 A servo is activated by creating an instance of the Servo2 class passing the desired pin to the attach() method.
 ...
 Servo2 - Class for manipulating servo motors connected to Arduino pins.
...
uint8_t Servo2::attach(int pin, int min, int max)
{
...
uint8_t Servo2::attach(int pin, int minimum, int maximum)
{
