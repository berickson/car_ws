  ...
  const std::string &type_name)
{
  ...
  std::cout << "about to create type support library for " << type_name << std::endl;
  auto library = rclcpp::get_typesupport_library(type_name, rosidl_typesupport_introspection_cpp::typesupport_identifier);
  std::cout << "done creating type support library" << std::endl;

  std::cout << "about to create type support handle for  " << type_name << std::endl;
  info.type_support =
    rosbag2_cpp::get_typesupport_handle(type_name, rosidl_typesupport_introspection_cpp::typesupport_identifier, library);
    //rosbag2_cpp::get_typesupport(type_name, rosidl_typesupport_introspection_cpp::typesupport_identifier);
  std::cout << "done getting type support handle for  " << type_name << std::endl;
